...
type App struct {
	...
	UrlType     string `boil:"urlType" json:"urlType" toml:"urlType" yaml:"urlType"`
...
var AppWhere = struct {
	...
	URL:         whereHelperstring{field: "\"apps\".\"URL\""},
	UrlType:     whereHelperstring{field: "\"apps\".\"urlType\""},
}
...
var (
	appAllColumns            = []string{"id", "title", "description", "URL", "urlType"}
	appColumnsWithoutDefault = []string{"id", "title", "description", "URL", "urlType"}
...
var appAfterSelectMu sync.Mutex
var appAfterSelectHooks []AppHook

var appBeforeInsertMu sync.Mutex
var appBeforeInsertHooks []AppHook
var appAfterInsertMu sync.Mutex
var appAfterInsertHooks []AppHook

var appBeforeUpdateMu sync.Mutex
var appBeforeUpdateHooks []AppHook
var appAfterUpdateMu sync.Mutex
var appAfterUpdateHooks []AppHook

var appBeforeDeleteMu sync.Mutex
var appBeforeDeleteHooks []AppHook
var appAfterDeleteMu sync.Mutex
var appAfterDeleteHooks []AppHook

var appBeforeUpsertMu sync.Mutex
var appBeforeUpsertHooks []AppHook
var appAfterUpsertMu sync.Mutex
...
func (q appQuery) One(ctx context.Context, exec boil.ContextExecutor) (*App, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db: failed to execute a one query for apps")
	}
...
func (q appQuery) All(ctx context.Context, exec boil.ContextExecutor) (AppSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "db: failed to assign all query results to App slice")
	}
...
func (q appQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to count apps rows")
	}
...
func (q appQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "db: failed to check if apps exists")
	}
...
func Apps(mods ...qm.QueryMod) appQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"apps\".*"})
	}
...
func FindApp(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*App, error) {
	appObj := &App{}
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db: unable to select from apps")
	}
...
func (o *App) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("db: no apps provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to insert into apps")
	}
...
func (o *App) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("db: unable to update apps, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update apps row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by update for apps")
	}
...
func (q appQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all for apps")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected for apps")
	}
...
func (o AppSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all in app slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected all in update all app")
	}
	return rowsAff, nil
}
...
func (o *App) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("db: no apps provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("db: unable to upsert apps, could not build update column list")
		}

		ret := strmangle.SetComplement(appAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(appPrimaryKeyColumns) == 0 {
				return errors.New("db: unable to upsert apps, could not build conflict column list")
			}

			conflict = make([]string, len(appPrimaryKeyColumns))
			copy(conflict, appPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"apps\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert apps")
	}
...
func (o *App) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("db: no App provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete from apps")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by delete for apps")
	}
...
func (q appQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("db: no appQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from apps")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by deleteall for apps")
	}
...
func (o AppSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from app slice")
	}
...
func (o *AppSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to reload all in AppSlice")
	}
...
func AppExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "db: unable to check if apps exists")
	}

	return exists, nil
}

// Exists checks if the App row exists.
func (o *App) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return AppExists(ctx, exec, o.ID)
}
