...
func (ec *executionContext) field_Mutation_createApp_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewApp2portfolioᚑapiᚋgraphᚋmodelᚐNewApp(ctx, tmp)
	}

	var zeroVal model.NewApp
	return zeroVal, nil
}
...
func (ec *executionContext) _App_title(ctx context.Context, field graphql.CollectedField, obj *model.App) (ret graphql.Marshaler) {
...
func (ec *executionContext) _App_URL(ctx context.Context, field graphql.CollectedField, obj *model.App) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Mutation_createApp(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNApp2ᚖportfolioᚑapiᚋgraphᚋmodelᚐApp(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_apps(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.App)
	fc.Result = res
	return ec.marshalNApp2ᚕᚖportfolioᚑapiᚋgraphᚋmodelᚐAppᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewApp(ctx context.Context, obj interface{}) (model.NewApp, error) {
	...
	fieldsInOrder := [...]string{"title", "description", "url", "urlType"}
...
func (ec *executionContext) marshalNApp2portfolioᚑapiᚋgraphᚋmodelᚐApp(ctx context.Context, sel ast.SelectionSet, v model.App) graphql.Marshaler {
	return ec._App(ctx, sel, &v)
}

func (ec *executionContext) marshalNApp2ᚕᚖportfolioᚑapiᚋgraphᚋmodelᚐAppᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.App) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNApp2ᚖportfolioᚑapiᚋgraphᚋmodelᚐApp(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNApp2ᚖportfolioᚑapiᚋgraphᚋmodelᚐApp(ctx context.Context, sel ast.SelectionSet, v *model.App) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNNewApp2portfolioᚑapiᚋgraphᚋmodelᚐNewApp(ctx context.Context, v interface{}) (model.NewApp, error) {
